...
/obj/machinery/dvalve/buildnodes()
...
/obj/machinery/dvalve/gas_flow()

	gas1.replace_by(ngas1)
	gas2.replace_by(ngas2)


/obj/machinery/dvalve/process()
...
/obj/machinery/dvalve/get_gas_val(from)
	if(from == vnode2)
		return gas2.tot_gas()/capmult
	else
		return gas1.tot_gas()/capmult

/obj/machinery/dvalve/get_gas(from)
	if(from == vnode2)
		return gas2
	return gas1

/obj/machinery/dvalve/proc/leak_to_turf(var/port)
...
/obj/machinery/dvalve/attack_paw(mob/user)
	attack_hand(user)

/obj/machinery/dvalve/attack_ai(var/mob/user as mob)
	return src.attack_hand(user)
	return

/obj/machinery/dvalve/attack_hand(mob/user)
	..()
	add_fingerprint(user)
	if(stat & NOPOWER) return
