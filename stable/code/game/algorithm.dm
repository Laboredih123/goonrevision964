...
/mob/human/proc/ShowChoices()
	...
	dat += text("<br> <b>Hair Style</b> - <a href='byond://?src=\ref[];h_style=input'>[]</a>", src, src.h_style)
	dat += text("<br> <b>Facial Style</b> - <a href='byond://?src=\ref[];f_style=input'>[]</a>", src, src.f_style)
