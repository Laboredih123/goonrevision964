/datum/game_mode/traitor
	...
	var/const/prob_right_murder_target_l = 30 // lower bound on probability of naming right assassination target
	var/const/prob_right_murder_target_h = 80 // upper bound on probability of naimg the right assassination target

	var/const/prob_int_item = 50 // intercept names the theft target half the time
	var/const/prob_right_item_l = 50 // lower bound on probability of naming right theft target
	var/const/prob_right_item_h = 70 // upper bound on probability of naming the right theft target
...
/datum/game_mode/traitor/proc/get_pickable_items(mob/killer)
	...
	if(killerrank == "Captain")
		return items - list(laser, captain_card, captain_suit) //too easy to steal
