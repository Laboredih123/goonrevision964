...
/proc/get_all_accesses()
	return list(access_security, access_brig, access_security_lockers, access_forensics_lockers,
	            ...
	            access_chaplain_office, access_tech_storage, access_atmospherics, access_emergency, access_secure_eva)
...
/proc/get_access_desc(A)
	switch(A)
		...
		if(access_secure_eva)			return "access secure EVA storage"
